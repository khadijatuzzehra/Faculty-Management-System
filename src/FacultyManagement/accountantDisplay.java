...
public class accountantDisplay{
    private StringProperty employeeId;
    private StringProperty employeeName;
    private StringProperty hireStatus;
    private StringProperty qualification;

    public accountantDisplay(){}

    public accountantDisplay(String employeeId, String employeeName, String hireStatus, String qualification) {
